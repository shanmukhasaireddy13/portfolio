        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">S Shanmukha Sai Reddy</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              A passionate B.Tech Computer Science student at VIT Chennai, specializing in full-stack development 
              and AI technologies. Always eager to learn and create innovative solutions.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 transform hover:scale-110"
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>s.shanmukhasaireddy13@gmail.com</p>
              <p>+91 7207174919</p>
              <p>Chennai, India</p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} S Shanmukha Sai Reddy. All rights reserved.
            </p>
